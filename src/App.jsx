...
function Cursor() {
  ...
  useEffect(() => {
    ...
    document
      .querySelectorAll("a, button, .project-item, .stack-item, .contact-link")
      .forEach((el) => {
    ...
    <section className="hero" id="home">
      ...
      <div className="hero-bottom">
        <p className="hero-desc">
          ...
          to distributed backend systems, turning complex problems into elegant
          code.
        </p>
      ...
      <div className="about-grid fade-up">
        ...
        <div>
          <p className="about-text">
            I'm a full-stack developer driven by a deep curiosity for Web3 and
            blockchain technologies, paired with a relentless obsession for
            clean architecture and performance. I operate at the intersection of
            design thinking and systems engineering—where beautiful, intuitive
            interfaces meet bulletproof backends.
          </p>
          <p className="about-text">
            My stack is opinionated: React.js on the frontend, Node/Express or
            serverless functions on the backend, with MY-SQL or MongoDB
            depending on the data shape. I deploy on AWS or Vercel and treat
            CI/CD as a first-class citizen.
          </p>
          <p className="about-text">
            When I'm not shipping code, I focus on mastering low-level systems
            engineering with Rust and developing high-performance applications
...
function Contact() {
  const links = [
    {
      label: "Email",
      value: "yashar93official@gmail.com",
      href: "yashar93official@gmail.com",
    },
    {
      label: "GitHub",
      value: "github.com/yasharox",
      href: "https://github.com/yasharox",
    },
    {
      label: "LinkedIn",
  ...
  return (
    <footer>
      <span className="footer-copy">
        © 2026 Yashar Dev — All rights reserved
      </span>
